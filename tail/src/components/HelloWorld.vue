...
<div>
    ...
    <table class="w-4/5 table-auto  border-thin border-2 border-gray-600 m-auto">
        <tbody>
            <tr class="border-thin border-2 border-gray-600 text-left">
                <th class="px-5">WIFI</th>
                <th>
                    <h1>SERVER</h1>
                    <a>https.com</a>
                </th>
    ...
    <div>
    <div class="blink">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6" color="green">
